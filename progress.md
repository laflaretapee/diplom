...
- Приложение визуально приведено к `Джейсан noir`: обновлены `frontend/src/app/theme.ts`, `frontend/src/styles/global.css`, `frontend/src/components/AppShell.tsx`, добавлен пункт меню склада для ролей `super_admin`, `franchisee`, `point_manager`.
