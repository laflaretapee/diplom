...
- notifications/kanban bot: `TELEGRAM_BOT_TOKEN`, `TELEGRAM_WEBHOOK_SECRET`
- sales Mini App bot: `SALES_TELEGRAM_BOT_TOKEN`, `SALES_TELEGRAM_WEBHOOK_SECRET`, `SALES_TELEGRAM_MINI_APP_URL`
